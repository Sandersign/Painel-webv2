...
exit;
  ...
  echo -e 'Modificado por: @smigolvip' >/usr/lib/telegram
  msg -bar
...
wget https://github.com/ruck18/Painel-webv2/raw/main/install/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://github.com/ruck18/Painel-webv2/raw/main/install/verifatt.sh > /dev/null 2>&1
wget https://github.com/ruck18/Painel-webv2/raw/main/install/verpweb > /dev/null 2>&1
wget https://github.com/ruck18/Painel-webv2/raw/main/install/verweb > /dev/null 2>&1
wget https://github.com/ruck18/Painel-webv2/raw/main/install/whatsapp.sh > /dev/null 2>&1
...
wget https://github.com/ruck18/Painel-webv2/raw/main/install/gestorssh.zip > /dev/null 2>&1
...
echo ""
echo -e "PAINEL WEB SMIGOLVIP SSH" | figlet | boxes -d stone -p a0v0 | lolcat
echo -e "                              \033[1;31mModificado por @smigolvip\033[1;36m" | lolcat
echo ""
chave=$(curl -sSL "https://github.com/ruck18/Painel-webv2/raw/main/install/chave") &>/dev/null
...
echo -e "PAINEL WEB SMIGOL SSH" | figlet | boxes -d stone -p a0v0 | lolcat
echo -e "                              \033[1;31mModificado por @smigolvip\033[1;36m" | lolcat
echo ""
